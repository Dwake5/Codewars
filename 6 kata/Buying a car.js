...
function nbMonths(startPriceOld, startPriceNew, savingPerMonth, percentLossByMonth) {
    ...
    while ((totalSaving + startPriceOld) < startPriceNew) {
      months += 1
      if (months % 2 === 0) {
        lossPercentage += 0.5 
      }
      totalSaving += savingPerMonth
      startPriceOld -= startPriceOld * (lossPercentage / 100)
      startPriceNew -= startPriceNew * (lossPercentage / 100)
    }
    return [months, Math.round(totalSaving + startPriceOld - startPriceNew)]
  }